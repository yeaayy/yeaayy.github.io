<template>
  <h2 class="text-2xl font-bold my-4">What is in this page?</h2>
  <p>This is where is put my stuff when I make something interesting. I also put some of my interest here and
    a little bit about myself.</p>

  <p class="mt-4">I made this site mainly because I want to create archive of thing I made. I feel spending too much
    on it so I want to know how much thing I actually made (and finished). The other reason is I also want to share
